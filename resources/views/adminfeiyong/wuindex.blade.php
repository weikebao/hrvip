    ...
    <div class="mws-panel grid_8">
       ...
       <div class="mws-panel-body no-padding">
            ...
            <div id="DataTables_Table_0_length" class="dataTables_length mws-form-row dataTables_filter">
               ...
               <input class=" mws-form-label" type="text" name="acount" value="{{$total}}" readonly="readonly" />元
            </div>
            ...
            $.ajax({
                ...
                success:function(mes)
                {
                   if(mes.length!=0)
                   {
                    ...
                    {  
                        $('.ceshi').append('<tr><td>'+val.uid+'</td><td class=" ">'+val.phone+'</td><td>'+val.total+'</td></tr>\
                        '); 
                    })
                    //将综合数据放到首页位置
            ...
            $.ajax({
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info" >
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 70px;">购买金额
                        </th>
                    </tr>
                    </thead>
