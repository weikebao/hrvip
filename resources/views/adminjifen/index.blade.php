...
@section('con')
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-table"></i>公司会员积分列表<b ><a href="/admin/jifen/index" style="color:red;margin-left: 75%;">回到首页</a></b></span>
        </div>
            ...
            <script type="text/javascript">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info" >
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 70px;">会员积分
                        </th>
                    ...
                    @foreach($res as $v)
                        <tr>
                            ...
                            <td class="">{{$v['name']}}</td>
                            <td class="">{{$v['phone']}}</td>
                            <td class="">{{$v['jifen']}}积分</td>
                            <td class=""><a href="/admin/jifen/laiyuan/{{$v['id']}}">积分来源情况</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
